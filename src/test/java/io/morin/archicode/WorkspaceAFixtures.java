...
public class WorkspaceAFixtures {
    ...
    static ObjectMapper objectMapper = JsonMapper.builder()
        ...
        .build();
    public static final System system_a_a = System.builder()
        .id("system_a_a")
        .name("System#A_A")
        .relationships(
            Set.of(
        ...
        .build();
    public static final System system_a_b = System.builder()
        .id("system_a_b")
        .name("System#A_B")
        .relationships(Set.of(Relationship.builder().destination("solution_b").label("uses").build()))
        .build();
    public static final Solution solution_a = Solution.builder()
        .id("solution_a")
        .name("Solution#A")
        .elements(Set.of(system_a_a, system_a_b))
        .relationships(Set.of(Relationship.builder().destination("solution_b").label("uses").build()))
        .build();
    public static final Solution solution_b = Solution.builder()
        .id("solution_b")
        .name("Solution#B")
        .description("label of Solution#B")
        .build();
    public static final Solution solution_c = Solution.builder()
        .id("solution_c")
        .name("Solution#C")
