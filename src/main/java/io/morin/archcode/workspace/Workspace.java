...
public class Workspace {
    ...
    public View getView(String viewId) {
        return searchView(viewId).orElseThrow(() -> new ArchcodeException("unable to find the view %s", viewId));
    }
    ...
    public Element getElementByReference(String reference) {
        return searchElement(reference)
            .orElseThrow(() -> new ArchcodeException("unable to find the element %s", reference));
    }
